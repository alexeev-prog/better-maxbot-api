...
class Subscription(object):
    ...
    def __init__(self, url=None, time=None, update_types=None, version=None):  # noqa: E501
    ...
    @property
    def time(self):
        """Gets the time of this Subscription.  # noqa: E501

        Unix-time when subscription was created  # noqa: E501

        :return: The time of this Subscription.  # noqa: E501
        :rtype: int
        """
        return self._time
    ...
    @time.setter
    def time(self, time):
        """Sets the time of this Subscription.

        Unix-time when subscription was created  # noqa: E501

        :param time: The time of this Subscription.  # noqa: E501
        :type: int
        """
        if time is None:
    ...
    def update_types(self):
        """Gets the update_types of this Subscription.  # noqa: E501

        Update types bot subscribed for  # noqa: E501

        :return: The update_types of this Subscription.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def update_types(self, update_types):
        """Sets the update_types of this Subscription.

        Update types bot subscribed for  # noqa: E501

        :param update_types: The update_types of this Subscription.  # noqa: E501
        :type: list[str]
        """
    ...
    def version(self, version):
        ...
        if version is not None and not re.search(
            ...
            raise ValueError(
                r"Invalid value for `version`, must be a follow pattern or equal to `/[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}/`"
            )  # noqa: E501

...
class BotRemovedFromChatUpdate(Update):
    ...
    def __init__(
        ...
        """BotRemovedFromChatUpdate - a model defined in OpenAPI"""  # noqa: E501
        super(BotRemovedFromChatUpdate, self).__init__(update_type, timestamp)
        self._chat_id = None
        self._user = None
    ...
    @property
    def chat_id(self):
        """Gets the chat_id of this BotRemovedFromChatUpdate.  # noqa: E501

        Chat identifier bot removed from  # noqa: E501

        :return: The chat_id of this BotRemovedFromChatUpdate.  # noqa: E501
        :rtype: int
        """
    ...
    def chat_id(self, chat_id):
        """Sets the chat_id of this BotRemovedFromChatUpdate.

        Chat identifier bot removed from  # noqa: E501

        :param chat_id: The chat_id of this BotRemovedFromChatUpdate.  # noqa: E501
        :type: int
        """
        if chat_id is None:
    ...
    @property
    def user(self):
        """Gets the user of this BotRemovedFromChatUpdate.  # noqa: E501

        User who removed bot from chat  # noqa: E501

        :return: The user of this BotRemovedFromChatUpdate.  # noqa: E501
        :rtype: User
        """
        return self._user
    ...
    @user.setter
    def user(self, user):
        """Sets the user of this BotRemovedFromChatUpdate.

        User who removed bot from chat  # noqa: E501

        :param user: The user of this BotRemovedFromChatUpdate.  # noqa: E501
        :type: User
        """
        if user is None:
    ...
    @property
    def is_channel(self):
        """Gets the is_channel of this BotRemovedFromChatUpdate.  # noqa: E501

        Indicates whether bot has been removed from channel or not  # noqa: E501

        :return: The is_channel of this BotRemovedFromChatUpdate.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_channel(self, is_channel):
        """Sets the is_channel of this BotRemovedFromChatUpdate.

        Indicates whether bot has been removed from channel or not  # noqa: E501

        :param is_channel: The is_channel of this BotRemovedFromChatUpdate.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BotRemovedFromChatUpdate):
            return False

...
class DataAttachment(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """DataAttachment - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this DataAttachment.  # noqa: E501


        :return: The data of this DataAttachment.  # noqa: E501
        :rtype: str
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this DataAttachment.


        :param data: The data of this DataAttachment.  # noqa: E501
        :type: str
        """
        if data is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DataAttachment):
            return False

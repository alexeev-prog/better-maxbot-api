...
class User(object):
    ...
    def username(self):
        ...
        Unique public user name. Can be `null` if user is not accessible or it is not set  # noqa: E501
    ...
    def is_bot(self, is_bot):
        ...
        """
        if is_bot is None:
            raise ValueError("Invalid value for `is_bot`, must not be `None`")  # noqa: E501
    ...
    def last_activity_time(self):
        ...
        Time of last user activity in Max (Unix timestamp in milliseconds). Can be outdated if user disabled its \"online\" status in settings  # noqa: E501
    ...
    def last_activity_time(self, last_activity_time):
        ...
        #     raise ValueError("Invalid value for `last_activity_time`, must not be `None`")  # noqa: E501

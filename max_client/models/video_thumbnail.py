...
class VideoThumbnail(object):
    ...
    def __init__(self, url=None):  # noqa: E501
        """VideoThumbnail - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def url(self):
        """Gets the url of this VideoThumbnail.  # noqa: E501

        Image URL  # noqa: E501

        :return: The url of this VideoThumbnail.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this VideoThumbnail.

        Image URL  # noqa: E501

        :param url: The url of this VideoThumbnail.  # noqa: E501
        :type: str
        """
        if url is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VideoThumbnail):
            return False

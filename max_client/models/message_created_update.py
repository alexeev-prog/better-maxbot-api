...
class MessageCreatedUpdate(Update):
    ...
    def __init__(
        ...
        """MessageCreatedUpdate - a model defined in OpenAPI"""  # noqa: E501

        super(MessageCreatedUpdate, self).__init__(update_type, timestamp)
        self._message = None
    ...
    @property
    def message(self):
        """Gets the message of this MessageCreatedUpdate.  # noqa: E501

        Newly created message  # noqa: E501

        :return: The message of this MessageCreatedUpdate.  # noqa: E501
        :rtype: Message
        """
    ...
    def message(self, message):
        """Sets the message of this MessageCreatedUpdate.

        Newly created message  # noqa: E501

        :param message: The message of this MessageCreatedUpdate.  # noqa: E501
        :type: Message
        """
        if message is None:
    ...
    def user_locale(self):
        """Gets the user_locale of this MessageCreatedUpdate.  # noqa: E501

        Current user locale in IETF BCP 47 format. Available only in dialogs  # noqa: E501

        :return: The user_locale of this MessageCreatedUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def user_locale(self, user_locale):
        """Sets the user_locale of this MessageCreatedUpdate.

        Current user locale in IETF BCP 47 format. Available only in dialogs  # noqa: E501

        :param user_locale: The user_locale of this MessageCreatedUpdate.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MessageCreatedUpdate):
            return False

...
class ChatAdmin(object):
    ...
    def __init__(self, user_id=None, permissions=None, alias=None):  # noqa: E501
        """ChatAdmin - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def user_id(self):
        """Gets the user_id of this ChatAdmin.  # noqa: E501


        :return: The user_id of this ChatAdmin.  # noqa: E501
        :rtype: int
        """
    ...
    def user_id(self, user_id):
        """Sets the user_id of this ChatAdmin.


        :param user_id: The user_id of this ChatAdmin.  # noqa: E501
        :type: int
        """
        if user_id is None:
    ...
    def permissions(self):
        """Gets the permissions of this ChatAdmin.  # noqa: E501


        :return: The permissions of this ChatAdmin.  # noqa: E501
    ...
    def permissions(self, permissions):
        """Sets the permissions of this ChatAdmin.


        :param permissions: The permissions of this ChatAdmin.  # noqa: E501
    ...
    @property
    def alias(self):
        """Gets the alias of this ChatAdmin.  # noqa: E501

        Alias of the admin in chat. By default, `null`  # noqa: E501

        :return: The alias of this ChatAdmin.  # noqa: E501
        :rtype: str
        """
        return self._alias
    ...
    def alias(self, alias):
        """Sets the alias of this ChatAdmin.

        Alias of the admin in chat. By default, `null`  # noqa: E501

        :param alias: The alias of this ChatAdmin.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ChatAdmin):
            return False

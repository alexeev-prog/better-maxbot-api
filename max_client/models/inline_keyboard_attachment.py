...
class InlineKeyboardAttachment(Attachment):
    ...
    """
    openapi_types = {"type": "str", "payload": "Keyboard"}

    attribute_map = {"type": "type", "payload": "payload"}

    def __init__(self, payload=None, type="inline_keyboard"):  # noqa: E501
        """InlineKeyboardAttachment - a model defined in OpenAPI"""  # noqa: E501
        super(InlineKeyboardAttachment, self).__init__(type)
        self._payload = None
    ...
    @property
    def payload(self):
        """Gets the payload of this InlineKeyboardAttachment.  # noqa: E501


        :return: The payload of this InlineKeyboardAttachment.  # noqa: E501
        :rtype: Keyboard
        """
    ...
    def payload(self, payload):
        """Sets the payload of this InlineKeyboardAttachment.


        :param payload: The payload of this InlineKeyboardAttachment.  # noqa: E501
        :type: Keyboard
        """
        if payload is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineKeyboardAttachment):
            return False

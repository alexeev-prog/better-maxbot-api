...
class LinkButton(Button):
    ...
    """
    openapi_types = {"type": "str", "text": "str", "url": "str"}

    attribute_map = {"type": "type", "text": "text", "url": "url"}

    def __init__(self, text=None, url=None, type="link"):  # noqa: E501
        """LinkButton - a model defined in OpenAPI"""  # noqa: E501
        super(LinkButton, self).__init__(type, text)
        self._url = None
    ...
    @property
    def url(self):
        """Gets the url of this LinkButton.  # noqa: E501


        :return: The url of this LinkButton.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this LinkButton.


        :param url: The url of this LinkButton.  # noqa: E501
        :type: str
        """
        if url is None:
        ...
        if url is not None and len(url) > 256:
            raise ValueError(
                "Invalid value for `url`, length must be less than or equal to `256`"
            )  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LinkButton):
            return False

...
class ActionRequestBody(object):
    """NOTE:"""
    ...
    """
    openapi_types = {"action": "SenderAction"}

    attribute_map = {"action": "action"}

    def __init__(self, action=None):  # noqa: E501
        """ActionRequestBody - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def action(self):
        """Gets the action of this ActionRequestBody.  # noqa: E501


        :return: The action of this ActionRequestBody.  # noqa: E501
        :rtype: SenderAction
        """
        return self._action
    ...
    def action(self, action):
        """Sets the action of this ActionRequestBody.


        :param action: The action of this ActionRequestBody.  # noqa: E501
        :type: SenderAction
        """
        if action is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ActionRequestBody):
            return False

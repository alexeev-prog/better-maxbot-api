...
class BotAddedToChatUpdate(Update):
    ...
    def __init__(
        ...
        """BotAddedToChatUpdate - a model defined in OpenAPI."""
    ...
    def chat_id(self):
        """
        Gets the chat_id of this BotAddedToChatUpdate.  # noqa: E501.

        Chat id where bot was added  # noqa: E501

        :return: The chat_id of this BotAddedToChatUpdate.  # noqa: E501
        :rtype: int
        """
    ...
    def chat_id(self, chat_id):
        """
        Sets the chat_id of this BotAddedToChatUpdate.

        Chat id where bot was added  # noqa: E501

        :param chat_id: The chat_id of this BotAddedToChatUpdate.  # noqa: E501
        :type: int
        """
        if chat_id is None:
    ...
    def user(self):
        """
        Gets the user of this BotAddedToChatUpdate.  # noqa: E501.

        User who added bot to chat  # noqa: E501

        :return: The user of this BotAddedToChatUpdate.  # noqa: E501
        :rtype: User
        """
        return self._user
    ...
    def user(self, user):
        """
        Sets the user of this BotAddedToChatUpdate.

        User who added bot to chat  # noqa: E501

        :param user: The user of this BotAddedToChatUpdate.  # noqa: E501
        :type: User
        """
        if user is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BotAddedToChatUpdate):
            return False

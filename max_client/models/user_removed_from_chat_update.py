...
class UserRemovedFromChatUpdate(Update):
    ...
    def __init__(
        ...
        """UserRemovedFromChatUpdate - a model defined in OpenAPI."""
    ...
    def chat_id(self):
        """
        Gets the chat_id of this UserRemovedFromChatUpdate.  # noqa: E501.

        Chat identifier where event has occurred  # noqa: E501

        :return: The chat_id of this UserRemovedFromChatUpdate.  # noqa: E501
        :rtype: int
        """
    ...
    def chat_id(self, chat_id):
        """
        Sets the chat_id of this UserRemovedFromChatUpdate.

        Chat identifier where event has occurred  # noqa: E501

        :param chat_id: The chat_id of this UserRemovedFromChatUpdate.  # noqa: E501
        :type: int
        """
        if chat_id is None:
    ...
    def user(self):
        """
        Gets the user of this UserRemovedFromChatUpdate.  # noqa: E501.

        User removed from chat  # noqa: E501

        :return: The user of this UserRemovedFromChatUpdate.  # noqa: E501
        :rtype: User
        """
        return self._user
    ...
    def user(self, user):
        """
        Sets the user of this UserRemovedFromChatUpdate.

        User removed from chat  # noqa: E501

        :param user: The user of this UserRemovedFromChatUpdate.  # noqa: E501
        :type: User
        """
        if user is None:
    ...
    def admin_id(self):
        """
        Gets the admin_id of this UserRemovedFromChatUpdate.  # noqa: E501.

        Administrator who removed user from chat. Can be `null` in case when user left chat  # noqa: E501

        :return: The admin_id of this UserRemovedFromChatUpdate.  # noqa: E501
        :rtype: int
        """
    ...
    def admin_id(self, admin_id):
        """
        Sets the admin_id of this UserRemovedFromChatUpdate.

        Administrator who removed user from chat. Can be `null` in case when user left chat  # noqa: E501

        :param admin_id: The admin_id of this UserRemovedFromChatUpdate.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserRemovedFromChatUpdate):
            return False

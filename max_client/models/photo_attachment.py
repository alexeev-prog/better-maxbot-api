...
class PhotoAttachment(Attachment):
    ...
    """
    openapi_types = {"type": "str", "payload": "PhotoAttachmentPayload"}

    attribute_map = {"type": "type", "payload": "payload"}

    def __init__(self, payload=None, type="image"):  # noqa: E501
        """PhotoAttachment - a model defined in OpenAPI"""  # noqa: E501
        super(PhotoAttachment, self).__init__(type)
        self._payload = None
    ...
    @property
    def payload(self):
        """Gets the payload of this PhotoAttachment.  # noqa: E501


        :return: The payload of this PhotoAttachment.  # noqa: E501
    ...
    def payload(self, payload):
        """Sets the payload of this PhotoAttachment.


        :param payload: The payload of this PhotoAttachment.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PhotoAttachment):
            return False

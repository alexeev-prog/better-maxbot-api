...
class VideoAttachmentRequest(AttachmentRequest):
    ...
    """
    openapi_types = {"type": "str", "payload": "UploadedInfo"}

    attribute_map = {"type": "type", "payload": "payload"}

    def __init__(self, payload=None, type="video"):  # noqa: E501
        """VideoAttachmentRequest - a model defined in OpenAPI"""  # noqa: E501
        super(VideoAttachmentRequest, self).__init__(type)
        self._payload = None
    ...
    @property
    def payload(self):
        """Gets the payload of this VideoAttachmentRequest.  # noqa: E501


        :return: The payload of this VideoAttachmentRequest.  # noqa: E501
        :rtype: UploadedInfo
        """
    ...
    def payload(self, payload):
        """Sets the payload of this VideoAttachmentRequest.


        :param payload: The payload of this VideoAttachmentRequest.  # noqa: E501
        :type: UploadedInfo
        """
        if payload is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VideoAttachmentRequest):
            return False

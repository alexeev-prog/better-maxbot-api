...
class RequestContactButton(Button):
    ...
    def __init__(self, text=None, type="request_contact"):  # noqa: E501
        """RequestContactButton - a model defined in OpenAPI"""  # noqa: E501
        super(RequestContactButton, self).__init__(type, text)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RequestContactButton):
            return False

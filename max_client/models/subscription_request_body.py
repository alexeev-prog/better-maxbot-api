...
class SubscriptionRequestBody(object):
    """NOTE:"""
    ...
    """
    openapi_types = {"url": "str", "update_types": "list[str]", "version": "str"}

    attribute_map = {"url": "url", "update_types": "update_types", "version": "version"}

    def __init__(self, url=None, update_types=None, version=None):  # noqa: E501
        """SubscriptionRequestBody - a model defined in OpenAPI"""  # noqa: E501
        ...
        if update_types is not None:
            ...
            self.update_types = Update.update_types
        if version is not None:
            self.version = version

    @property
    def url(self):
        """Gets the url of this SubscriptionRequestBody.  # noqa: E501

        URL of HTTP(S)-endpoint of your bot. Must starts with http(s)://  # noqa: E501

        :return: The url of this SubscriptionRequestBody.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this SubscriptionRequestBody.

        URL of HTTP(S)-endpoint of your bot. Must starts with http(s)://  # noqa: E501

        :param url: The url of this SubscriptionRequestBody.  # noqa: E501
        :type: str
        """
        if url is None:
    ...
    def update_types(self):
        """Gets the update_types of this SubscriptionRequestBody.  # noqa: E501

        List of update types your bot want to receive. See `Update` object for a complete list of types  # noqa: E501

        :return: The update_types of this SubscriptionRequestBody.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def update_types(self, update_types):
        """Sets the update_types of this SubscriptionRequestBody.

        List of update types your bot want to receive. See `Update` object for a complete list of types  # noqa: E501

        :param update_types: The update_types of this SubscriptionRequestBody.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def version(self):
        """Gets the version of this SubscriptionRequestBody.  # noqa: E501

        Version of API. Affects model representation  # noqa: E501

        :return: The version of this SubscriptionRequestBody.  # noqa: E501
        :rtype: str
        """
    ...
    def version(self, version):
        """Sets the version of this SubscriptionRequestBody.

        Version of API. Affects model representation  # noqa: E501

        :param version: The version of this SubscriptionRequestBody.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SubscriptionRequestBody):
            return False

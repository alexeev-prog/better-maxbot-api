...
class ShareAttachmentRequest(AttachmentRequest):
    ...
    """
    openapi_types = {"type": "str", "payload": "ShareAttachmentPayload"}

    attribute_map = {"type": "type", "payload": "payload"}

    def __init__(self, payload=None, type="share"):
        """ShareAttachmentRequest - a model defined in OpenAPI."""
        super().__init__(type)
        self._payload = None
    ...
    def payload(self):
        """
        Gets the payload of this ShareAttachmentRequest.  # noqa: E501.

        :return: The payload of this ShareAttachmentRequest.  # noqa: E501
    ...
    def payload(self, payload):
        """
        Sets the payload of this ShareAttachmentRequest.

        :param payload: The payload of this ShareAttachmentRequest.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShareAttachmentRequest):
            return False

...
class MessageEditedUpdate(Update):
    ...
    """
    openapi_types = {"update_type": "str", "timestamp": "int", "message": "Message"}
    ...
    def __init__(self, timestamp=None, message=None, update_type="message_edited"):  # noqa: E501
        """MessageEditedUpdate - a model defined in OpenAPI"""  # noqa: E501
        super(MessageEditedUpdate, self).__init__(update_type, timestamp)
        self._message = None
    ...
    @property
    def message(self):
        """Gets the message of this MessageEditedUpdate.  # noqa: E501

        Edited message  # noqa: E501

        :return: The message of this MessageEditedUpdate.  # noqa: E501
        :rtype: Message
        """
    ...
    def message(self, message):
        """Sets the message of this MessageEditedUpdate.

        Edited message  # noqa: E501

        :param message: The message of this MessageEditedUpdate.  # noqa: E501
        :type: Message
        """
        if message is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MessageEditedUpdate):
            return False

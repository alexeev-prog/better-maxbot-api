...
class BotCommand(object):
    ...
    def __init__(self, name=None, description=None):  # noqa: E501
        """BotCommand - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this BotCommand.  # noqa: E501

        Command name  # noqa: E501

        :return: The name of this BotCommand.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this BotCommand.

        Command name  # noqa: E501

        :param name: The name of this BotCommand.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def description(self):
        ...
        Optional command description  # noqa: E501

...
class UploadEndpoint(object):
    ...
    def __init__(self, url=None):  # noqa: E501
        """UploadEndpoint - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def url(self):
        """Gets the url of this UploadEndpoint.  # noqa: E501

        URL to upload  # noqa: E501

        :return: The url of this UploadEndpoint.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this UploadEndpoint.

        URL to upload  # noqa: E501

        :param url: The url of this UploadEndpoint.  # noqa: E501
        :type: str
        """
        if url is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UploadEndpoint):
            return False

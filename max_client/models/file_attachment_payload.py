...
class FileAttachmentPayload(AttachmentPayload):
    ...
    def __init__(self, url=None, token=None):
        """FileAttachmentPayload - a model defined in OpenAPI."""
        super().__init__(url)
    ...
    def token(self):
        """
        Gets the token of this FileAttachmentPayload.  # noqa: E501.

        Use `token` in case when you are trying to reuse the same attachment in other message  # noqa: E501

        :return: The token of this FileAttachmentPayload.  # noqa: E501
        :rtype: str
        """
        return self._token
    ...
    def token(self, token):
        """
        Sets the token of this FileAttachmentPayload.

        Use `token` in case when you are trying to reuse the same attachment in other message  # noqa: E501

        :param token: The token of this FileAttachmentPayload.  # noqa: E501
        :type: str
        """
        if token is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FileAttachmentPayload):
            return False

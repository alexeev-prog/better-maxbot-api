...
class ReplyKeyboardAttachmentRequest(object):
    """NOTE:"""
    ...
    def __init__(self, direct=False, direct_user_id=None, buttons=None):  # noqa: E501
        """ReplyKeyboardAttachmentRequest - a model defined in OpenAPI"""  # noqa: E501

        self._direct = None
        self._direct_user_id = None
        self._buttons = None
        ...
        if direct_user_id is not None:
            self.direct_user_id = direct_user_id
        self.buttons = buttons

    @property
    def direct(self):
        """Gets the direct of this ReplyKeyboardAttachmentRequest.  # noqa: E501

        Applicable only for chats. If `true` keyboard will be shown only for user bot mentioned or replied  # noqa: E501

        :return: The direct of this ReplyKeyboardAttachmentRequest.  # noqa: E501
        :rtype: bool
        """
        return self._direct
    ...
    def direct(self, direct):
        """Sets the direct of this ReplyKeyboardAttachmentRequest.

        Applicable only for chats. If `true` keyboard will be shown only for user bot mentioned or replied  # noqa: E501

        :param direct: The direct of this ReplyKeyboardAttachmentRequest.  # noqa: E501
        :type: bool
        """
    ...
    def direct_user_id(self):
        """Gets the direct_user_id of this ReplyKeyboardAttachmentRequest.  # noqa: E501

        If set to `true`, reply keyboard will only be shown to this participant in chat  # noqa: E501

        :return: The direct_user_id of this ReplyKeyboardAttachmentRequest.  # noqa: E501
        :rtype: int
        """
        return self._direct_user_id

    @direct_user_id.setter
    def direct_user_id(self, direct_user_id):
        """Sets the direct_user_id of this ReplyKeyboardAttachmentRequest.

        If set to `true`, reply keyboard will only be shown to this participant in chat  # noqa: E501

        :param direct_user_id: The direct_user_id of this ReplyKeyboardAttachmentRequest.  # noqa: E501
        :type: int
        """

        self._direct_user_id = direct_user_id

    @property
    def buttons(self):
        """Gets the buttons of this ReplyKeyboardAttachmentRequest.  # noqa: E501

        Two-dimensional array of buttons  # noqa: E501

        :return: The buttons of this ReplyKeyboardAttachmentRequest.  # noqa: E501
        :rtype: list[list[ReplyButton]]
        """
        return self._buttons

    @buttons.setter
    def buttons(self, buttons):
        """Sets the buttons of this ReplyKeyboardAttachmentRequest.

        Two-dimensional array of buttons  # noqa: E501

        :param buttons: The buttons of this ReplyKeyboardAttachmentRequest.  # noqa: E501
        :type: list[list[ReplyButton]]
        """
        if buttons is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReplyKeyboardAttachmentRequest):
            return False

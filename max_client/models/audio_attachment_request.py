...
class AudioAttachmentRequest(AttachmentRequest):
    ...
    def __init__(self, payload=None, type="audio"):  # noqa: E501
        """AudioAttachmentRequest - a model defined in OpenAPI"""  # noqa: E501
        super(AudioAttachmentRequest, self).__init__(type)
        self._payload = None
    ...
    @property
    def payload(self):
        """Gets the payload of this AudioAttachmentRequest.  # noqa: E501


        :return: The payload of this AudioAttachmentRequest.  # noqa: E501
        :rtype: UploadedInfo
        """
    ...
    def payload(self, payload):
        """Sets the payload of this AudioAttachmentRequest.


        :param payload: The payload of this AudioAttachmentRequest.  # noqa: E501
        :type: UploadedInfo
        """
        if payload is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AudioAttachmentRequest):
            return False

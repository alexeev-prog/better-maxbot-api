...
class InlineKeyboardAttachmentRequest(AttachmentRequest):
    ...
    """
    openapi_types = {"type": "str", "payload": "InlineKeyboardAttachmentRequestPayload"}

    attribute_map = {"type": "type", "payload": "payload"}

    def __init__(self, payload=None, type="inline_keyboard"):  # noqa: E501
        """InlineKeyboardAttachmentRequest - a model defined in OpenAPI"""  # noqa: E501
        super(InlineKeyboardAttachmentRequest, self).__init__(type)
        self._payload = None
    ...
    @property
    def payload(self):
        """Gets the payload of this InlineKeyboardAttachmentRequest.  # noqa: E501


        :return: The payload of this InlineKeyboardAttachmentRequest.  # noqa: E501
        :rtype: InlineKeyboardAttachmentRequestPayload
        """
        return self._payload

    @payload.setter
    def payload(self, payload):
        """Sets the payload of this InlineKeyboardAttachmentRequest.


        :param payload: The payload of this InlineKeyboardAttachmentRequest.  # noqa: E501
        :type: InlineKeyboardAttachmentRequestPayload
        """
        if payload is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineKeyboardAttachmentRequest):
            return False

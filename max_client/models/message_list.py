...
class MessageList(object):
    ...
    """
    openapi_types = {"messages": "list[Message]"}

    attribute_map = {"messages": "messages"}

    def __init__(self, messages=None):  # noqa: E501
        """MessageList - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def messages(self):
        """Gets the messages of this MessageList.  # noqa: E501

        List of messages  # noqa: E501

        :return: The messages of this MessageList.  # noqa: E501
        :rtype: list[Message]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MessageList):
            return False

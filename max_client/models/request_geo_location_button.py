...
class RequestGeoLocationButton(Button):
    ...
    """
    openapi_types = {"type": "str", "text": "str", "quick": "bool"}

    attribute_map = {"type": "type", "text": "text", "quick": "quick"}

    def __init__(self, text=None, quick=False, type="request_geo_location"):  # noqa: E501
        """RequestGeoLocationButton - a model defined in OpenAPI"""  # noqa: E501
        super(RequestGeoLocationButton, self).__init__(type, text)
    ...
    @property
    def quick(self):
        """Gets the quick of this RequestGeoLocationButton.  # noqa: E501

        If *true*, sends location without asking user's confirmation  # noqa: E501

        :return: The quick of this RequestGeoLocationButton.  # noqa: E501
        :rtype: bool
        """
        return self._quick
    ...
    def quick(self, quick):
        """Sets the quick of this RequestGeoLocationButton.

        If *true*, sends location without asking user's confirmation  # noqa: E501

        :param quick: The quick of this RequestGeoLocationButton.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RequestGeoLocationButton):
            return False

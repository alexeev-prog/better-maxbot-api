...
class LinkedMessage(object):
    ...
    def __init__(self, type=None, sender=None, chat_id=None, message=None):  # noqa: E501
        """LinkedMessage - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def type(self):
        """Gets the type of this LinkedMessage.  # noqa: E501

        Type of linked message  # noqa: E501

        :return: The type of this LinkedMessage.  # noqa: E501
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this LinkedMessage.

        Type of linked message  # noqa: E501

        :param type: The type of this LinkedMessage.  # noqa: E501
        :type: MessageLinkType
        """
        if type is None:
    ...
    @property
    def sender(self):
        """Gets the sender of this LinkedMessage.  # noqa: E501

        User sent this message. Can be `null` if message has been posted on behalf of a channel  # noqa: E501

        :return: The sender of this LinkedMessage.  # noqa: E501
        :rtype: User
        """
        return self._sender
    ...
    def sender(self, sender):
        """Sets the sender of this LinkedMessage.

        User sent this message. Can be `null` if message has been posted on behalf of a channel  # noqa: E501

        :param sender: The sender of this LinkedMessage.  # noqa: E501
        :type: User
        """
    ...
    @property
    def chat_id(self):
        """Gets the chat_id of this LinkedMessage.  # noqa: E501

        Chat where message has been originally posted. For forwarded messages only  # noqa: E501

        :return: The chat_id of this LinkedMessage.  # noqa: E501
        :rtype: int
        """
    ...
    def chat_id(self, chat_id):
        """Sets the chat_id of this LinkedMessage.

        Chat where message has been originally posted. For forwarded messages only  # noqa: E501

        :param chat_id: The chat_id of this LinkedMessage.  # noqa: E501
        :type: int
        """
    ...
    @property
    def message(self):
        """Gets the message of this LinkedMessage.  # noqa: E501


        :return: The message of this LinkedMessage.  # noqa: E501
        :rtype: MessageBody
        """
    ...
    def message(self, message):
        """Sets the message of this LinkedMessage.


        :param message: The message of this LinkedMessage.  # noqa: E501
        :type: MessageBody
        """
        # Может быть пустым в определённых случаях...
        # if message is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LinkedMessage):
            return False

...
class MediaAttachmentPayload(AttachmentPayload):
    ...
    """
    openapi_types = {"url": "str", "token": "str"}

    attribute_map = {"url": "url", "token": "token"}

    def __init__(self, url=None, token=None):  # noqa: E501
        """MediaAttachmentPayload - a model defined in OpenAPI"""  # noqa: E501
        super(MediaAttachmentPayload, self).__init__(url)
    ...
    @property
    def token(self):
        """Gets the token of this MediaAttachmentPayload.  # noqa: E501

        Use `token` in case when you are trying to reuse the same attachment in other message  # noqa: E501

        :return: The token of this MediaAttachmentPayload.  # noqa: E501
        :rtype: str
        """
        return self._token
    ...
    def token(self, token):
        """Sets the token of this MediaAttachmentPayload.

        Use `token` in case when you are trying to reuse the same attachment in other message  # noqa: E501

        :param token: The token of this MediaAttachmentPayload.  # noqa: E501
        :type: str
        """
        if token is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MediaAttachmentPayload):
            return False

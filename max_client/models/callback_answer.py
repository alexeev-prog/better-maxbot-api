...
class CallbackAnswer(object):
    ...
    """
    openapi_types = {"message": "NewMessageBody", "notification": "str"}

    attribute_map = {"message": "message", "notification": "notification"}

    def __init__(self, message=None, notification=None):  # noqa: E501
        """CallbackAnswer - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def message(self):
        """Gets the message of this CallbackAnswer.  # noqa: E501

        Fill this if you want to modify current message  # noqa: E501

        :return: The message of this CallbackAnswer.  # noqa: E501
        :rtype: NewMessageBody
        """
        return self._message

    @message.setter
    def message(self, message):
        """Sets the message of this CallbackAnswer.

        Fill this if you want to modify current message  # noqa: E501

        :param message: The message of this CallbackAnswer.  # noqa: E501
        :type: NewMessageBody
        """
    ...
    def notification(self):
        """Gets the notification of this CallbackAnswer.  # noqa: E501

        Fill this if you just want to send one-time notification to user  # noqa: E501

        :return: The notification of this CallbackAnswer.  # noqa: E501
        :rtype: str
        """
    ...
    def notification(self, notification):
        """Sets the notification of this CallbackAnswer.

        Fill this if you just want to send one-time notification to user  # noqa: E501

        :param notification: The notification of this CallbackAnswer.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CallbackAnswer):
            return False

...
class StrongMarkup(MarkupElement):
    ...
    def __init__(self, type="strong", _from=None, length=None):  # noqa: E501
        """StrongMarkup - a model defined in OpenAPI"""  # noqa: E501
        super(StrongMarkup, self).__init__(type, _from, length)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StrongMarkup):
            return False

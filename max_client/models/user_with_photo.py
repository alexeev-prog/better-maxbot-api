...
class UserWithPhoto(User):
    ...
    def __init__(
        ...
        """UserWithPhoto - a model defined in OpenAPI."""
        super().__init__(
            user_id, name, first_name, last_name, username, is_bot, last_activity_time
        )
    ...
    def description(self):
        """
        Gets the description of this UserWithPhoto.  # noqa: E501.

        User description. Can be `null` if user did not fill it out  # noqa: E501

        :return: The description of this UserWithPhoto.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this UserWithPhoto.

        User description. Can be `null` if user did not fill it out  # noqa: E501

        :param description: The description of this UserWithPhoto.  # noqa: E501
        :type: str
        """
    ...
    def avatar_url(self):
        """
        Gets the avatar_url of this UserWithPhoto.  # noqa: E501.

        URL of avatar  # noqa: E501

        :return: The avatar_url of this UserWithPhoto.  # noqa: E501
        :rtype: str
        """
    ...
    def avatar_url(self, avatar_url):
        """
        Sets the avatar_url of this UserWithPhoto.

        URL of avatar  # noqa: E501

        :param avatar_url: The avatar_url of this UserWithPhoto.  # noqa: E501
        :type: str
        """
    ...
    def full_avatar_url(self):
        """
        Gets the full_avatar_url of this UserWithPhoto.  # noqa: E501.

        URL of avatar of a bigger size  # noqa: E501

        :return: The full_avatar_url of this UserWithPhoto.  # noqa: E501
        :rtype: str
        """
        return self._full_avatar_url

    @full_avatar_url.setter
    def full_avatar_url(self, full_avatar_url):
        """
        Sets the full_avatar_url of this UserWithPhoto.

        URL of avatar of a bigger size  # noqa: E501

        :param full_avatar_url: The full_avatar_url of this UserWithPhoto.  # noqa: E501
        :type: str
        """
        self._full_avatar_url = full_avatar_url
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserWithPhoto):
            return False

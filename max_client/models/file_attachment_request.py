...
class FileAttachmentRequest(AttachmentRequest):
    ...
    def __init__(self, payload=None, type="file"):  # noqa: E501
        """FileAttachmentRequest - a model defined in OpenAPI"""  # noqa: E501
        super(FileAttachmentRequest, self).__init__(type)
        self._payload = None
    ...
    @property
    def payload(self):
        """Gets the payload of this FileAttachmentRequest.  # noqa: E501


        :return: The payload of this FileAttachmentRequest.  # noqa: E501
        :rtype: UploadedInfo
        """
    ...
    def payload(self, payload):
        """Sets the payload of this FileAttachmentRequest.


        :param payload: The payload of this FileAttachmentRequest.  # noqa: E501
        :type: UploadedInfo
        """
        if payload is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FileAttachmentRequest):
            return False

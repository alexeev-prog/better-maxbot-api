...
class ChatMembersList(object):
    ...
    """
    openapi_types = {"members": "list[ChatMember]", "marker": "int"}

    attribute_map = {"members": "members", "marker": "marker"}

    def __init__(self, members=None, marker=None):  # noqa: E501
        """ChatMembersList - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def members(self):
        """Gets the members of this ChatMembersList.  # noqa: E501

        Participants in chat with time of last activity. Visible only for chat admins  # noqa: E501

        :return: The members of this ChatMembersList.  # noqa: E501
    ...
    def members(self, members):
        """Sets the members of this ChatMembersList.

        Participants in chat with time of last activity. Visible only for chat admins  # noqa: E501

        :param members: The members of this ChatMembersList.  # noqa: E501
    ...
    @property
    def marker(self):
        """Gets the marker of this ChatMembersList.  # noqa: E501

        Pointer to the next data page  # noqa: E501

        :return: The marker of this ChatMembersList.  # noqa: E501
        :rtype: int
        """
        return self._marker
    ...
    def marker(self, marker):
        """Sets the marker of this ChatMembersList.

        Pointer to the next data page  # noqa: E501

        :param marker: The marker of this ChatMembersList.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ChatMembersList):
            return False

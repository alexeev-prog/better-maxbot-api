...
class FileAttachment(Attachment):
    ...
    def __init__(self, payload=None, filename=None, size=None, type="file"):  # noqa: E501
        """FileAttachment - a model defined in OpenAPI"""  # noqa: E501
        super(FileAttachment, self).__init__(type)
        self._payload = None
        self._filename = None
        self._size = None
    ...
    @property
    def payload(self):
        """Gets the payload of this FileAttachment.  # noqa: E501


        :return: The payload of this FileAttachment.  # noqa: E501
        :rtype: FileAttachmentPayload
        """
        return self._payload

    @payload.setter
    def payload(self, payload):
        """Sets the payload of this FileAttachment.


        :param payload: The payload of this FileAttachment.  # noqa: E501
    ...
    @property
    def size(self):
        """Gets the size of this FileAttachment.  # noqa: E501

        File size in bytes  # noqa: E501

        :return: The size of this FileAttachment.  # noqa: E501
        :rtype: int
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this FileAttachment.

        File size in bytes  # noqa: E501

        :param size: The size of this FileAttachment.  # noqa: E501
        :type: int
        """
        if size is None:

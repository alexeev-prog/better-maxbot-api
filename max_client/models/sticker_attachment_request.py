...
class StickerAttachmentRequest(AttachmentRequest):
    ...
    """
    openapi_types = {"type": "str", "payload": "StickerAttachmentRequestPayload"}

    attribute_map = {"type": "type", "payload": "payload"}

    def __init__(self, payload=None, type="sticker"):  # noqa: E501
        """StickerAttachmentRequest - a model defined in OpenAPI"""  # noqa: E501
        super(StickerAttachmentRequest, self).__init__(type)
        self._payload = None
    ...
    @property
    def payload(self):
        """Gets the payload of this StickerAttachmentRequest.  # noqa: E501


        :return: The payload of this StickerAttachmentRequest.  # noqa: E501
        :rtype: StickerAttachmentRequestPayload
        """
        return self._payload

    @payload.setter
    def payload(self, payload):
        """Sets the payload of this StickerAttachmentRequest.


        :param payload: The payload of this StickerAttachmentRequest.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StickerAttachmentRequest):
            return False

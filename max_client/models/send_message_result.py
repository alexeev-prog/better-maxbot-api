...
class SendMessageResult(object):
    ...
    def __init__(self, message=None):  # noqa: E501
        """SendMessageResult - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def message(self):
        """Gets the message of this SendMessageResult.  # noqa: E501


        :return: The message of this SendMessageResult.  # noqa: E501
        :rtype: Message
        """
    ...
    def message(self, message):
        """Sets the message of this SendMessageResult.


        :param message: The message of this SendMessageResult.  # noqa: E501
        :type: Message
        """
        if message is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SendMessageResult):
            return False

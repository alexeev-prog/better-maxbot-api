...
class MessageBody:
    ...
    def __init__(self, mid=None, seq=None, text=None, attachments=None, markup=None):
        ...
        self._text_markdown = None

    @property
    def mid(self):
        """
        Gets the mid of this MessageBody.  # noqa: E501.

        Unique identifier of message  # noqa: E501

        :return: The mid of this MessageBody.  # noqa: E501
        :rtype: str
        """
        return self._mid
    ...
    def mid(self, mid):
        """
        Sets the mid of this MessageBody.

        Unique identifier of message  # noqa: E501

        :param mid: The mid of this MessageBody.  # noqa: E501
        :type: str
        """
        if mid is None:
    ...
    def seq(self):
        """
        Gets the seq of this MessageBody.  # noqa: E501.

        Sequence identifier of message in chat  # noqa: E501

        :return: The seq of this MessageBody.  # noqa: E501
        :rtype: int
        """
        return self._seq
    ...
    def seq(self, seq):
        """
        Sets the seq of this MessageBody.

        Sequence identifier of message in chat  # noqa: E501

        :param seq: The seq of this MessageBody.  # noqa: E501
        :type: int
        """
        if seq is None:
    ...
    def text(self):
        """
        Gets the text of this MessageBody.  # noqa: E501.

        Message text  # noqa: E501

        :return: The text of this MessageBody.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    def text(self, text):
        ...
        :param text: The text of this MessageBody.  # noqa: E501
        :type: str
        """
        self._text = text
        self._text_html = None
    ...
    def attachments(self):
        """
        Gets the attachments of this MessageBody.  # noqa: E501.

        Message attachments. Could be one of `Attachment` type. See description of this schema  # noqa: E501

        :return: The attachments of this MessageBody.  # noqa: E501
    ...
    def attachments(self, attachments):
        """
        Sets the attachments of this MessageBody.

        Message attachments. Could be one of `Attachment` type. See description of this schema  # noqa: E501

        :param attachments: The attachments of this MessageBody.  # noqa: E501
    ...
    def text_html(self):
        if self._text_html is None:
            self._text_html = MarkupElement.get_formated_markup_text(
                self.text,
                MarkupElement.parse_markups(self.text, self.markup),
                TextFormat.HTML,
            )
    ...
    def text_markdown(self):
        if self._text_markdown is None:
            self._text_markdown = MarkupElement.get_formated_markup_text(
                self.text,
                MarkupElement.parse_markups(self.text, self.markup),
                TextFormat.MARKDOWN,
            )

...
class PhotoAttachmentPayload(object):
    """NOTE:"""
    ...
    """
    openapi_types = {"photo_id": "int", "token": "str", "url": "str"}

    attribute_map = {"photo_id": "photo_id", "token": "token", "url": "url"}

    def __init__(self, photo_id=None, token=None, url=None):  # noqa: E501
        """PhotoAttachmentPayload - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def photo_id(self):
        """Gets the photo_id of this PhotoAttachmentPayload.  # noqa: E501

        Unique identifier of this image  # noqa: E501

        :return: The photo_id of this PhotoAttachmentPayload.  # noqa: E501
        :rtype: int
        """
    ...
    def photo_id(self, photo_id):
        """Sets the photo_id of this PhotoAttachmentPayload.

        Unique identifier of this image  # noqa: E501

        :param photo_id: The photo_id of this PhotoAttachmentPayload.  # noqa: E501
        :type: int
        """
        # None Is Possible. For example, when returning responses from the API
        # if photo_id is None:
    ...
    @property
    def token(self):
        """Gets the token of this PhotoAttachmentPayload.  # noqa: E501


        :return: The token of this PhotoAttachmentPayload.  # noqa: E501
        :rtype: str
        """
        return self._token
    ...
    def token(self, token):
        """Sets the token of this PhotoAttachmentPayload.


        :param token: The token of this PhotoAttachmentPayload.  # noqa: E501
        :type: str
        """
        # None Is Possible. For example, when returning responses from the API
        # if token is None:
    ...
    @property
    def url(self):
        """Gets the url of this PhotoAttachmentPayload.  # noqa: E501

        Image URL  # noqa: E501

        :return: The url of this PhotoAttachmentPayload.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this PhotoAttachmentPayload.

        Image URL  # noqa: E501

        :param url: The url of this PhotoAttachmentPayload.  # noqa: E501
        :type: str
        """
        if url is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PhotoAttachmentPayload):
            return False

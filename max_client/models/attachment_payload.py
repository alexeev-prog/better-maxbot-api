...
class AttachmentPayload(object):
    ...
    def __init__(self, url=None):  # noqa: E501
        """AttachmentPayload - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def url(self):
        """Gets the url of this AttachmentPayload.  # noqa: E501

        Media attachment URL. For video attachments use [getVideoAttachmentDetails](#operation/getVideoAttachmentDetails) method to obtain direct links.  # noqa: E501

        :return: The url of this AttachmentPayload.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this AttachmentPayload.

        Media attachment URL. For video attachments use [getVideoAttachmentDetails](#operation/getVideoAttachmentDetails) method to obtain direct links.  # noqa: E501

        :param url: The url of this AttachmentPayload.  # noqa: E501
        :type: str
        """
        if url is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AttachmentPayload):
            return False

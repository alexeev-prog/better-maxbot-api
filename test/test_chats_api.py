...
class TestChatsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = max_client.api.chats_api.ChatsApi()  # noqa: E501
    ...
    def test_delete_admins(self):
        """Test case for delete_admins

        Revoke admin rights  # noqa: E501
        """
        pass
    ...
    def test_get_chat_by_link(self):
        """Test case for get_chat_by_link
    ...
    def test_get_pinned_message(self):
        """Test case for get_pinned_message
    ...
    def test_pin_message(self):
        """Test case for pin_message

        Pin message  # noqa: E501
        """
        pass

    def test_post_admins(self):
        """Test case for post_admins

        Set chat admins  # noqa: E501
        """
        pass

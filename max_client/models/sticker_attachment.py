...
class StickerAttachment(Attachment):
    ...
    def __init__(self, payload=None, width=None, height=None, type="sticker"):  # noqa: E501
        """StickerAttachment - a model defined in OpenAPI"""  # noqa: E501
        super(StickerAttachment, self).__init__(type)
        self._payload = None
        self._width = None
        self._height = None
    ...
    def payload(self):
        ...
        :rtype: StickerAttachmentPayload
        """

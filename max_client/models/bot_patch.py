...
class BotPatch(object):
    ...
    def __init__(
        self, name=None, first_name=None, description=None, commands=None, photo=None
    ):  # noqa: E501
        """BotPatch - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this BotPatch.  # noqa: E501

        Visible name of bot  # noqa: E501

        :return: The name of this BotPatch.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this BotPatch.

        Visible name of bot  # noqa: E501

        :param name: The name of this BotPatch.  # noqa: E501
        :type: str
        """
        if name is not None and len(name) > 59:
            raise ValueError(
                "Invalid value for `name`, length must be less than or equal to `59`"
            )  # noqa: E501
    ...
    @property
    def first_name(self):
        """Gets the first_name of this BotPatch.  # noqa: E501

        Visible name of bot  # noqa: E501

        :return: The first_name of this BotPatch.  # noqa: E501
        :rtype: str
        """
    ...
    def first_name(self, first_name):
        """Sets the first_name of this BotPatch.

        Visible name of bot  # noqa: E501

        :param first_name: The first_name of this BotPatch.  # noqa: E501
        :type: str
        """
        if first_name is not None and len(first_name) > 59:
            raise ValueError(
                "Invalid value for `first_name`, length must be less than or equal to `59`"
            )  # noqa: E501
    ...
    def description(self):
        """Gets the description of this BotPatch.  # noqa: E501

        Bot description up to 16k characters long  # noqa: E501

        :return: The description of this BotPatch.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this BotPatch.

        Bot description up to 16k characters long  # noqa: E501

        :param description: The description of this BotPatch.  # noqa: E501
        :type: str
        """
        if description is not None and len(description) > 16000:
            raise ValueError(
                "Invalid value for `description`, length must be less than or equal to `16000`"
            )  # noqa: E501
    ...
    @property
    def commands(self):
        """Gets the commands of this BotPatch.  # noqa: E501

        Commands supported by bot. Pass empty list if you want to remove commands  # noqa: E501

        :return: The commands of this BotPatch.  # noqa: E501
    ...
    def commands(self, commands):
        """Sets the commands of this BotPatch.

        Commands supported by bot. Pass empty list if you want to remove commands  # noqa: E501

        :param commands: The commands of this BotPatch.  # noqa: E501
    ...
    @property
    def photo(self):
        """Gets the photo of this BotPatch.  # noqa: E501

        Request to set bot photo  # noqa: E501

        :return: The photo of this BotPatch.  # noqa: E501
        :rtype: PhotoAttachmentRequestPayload
        """
        return self._photo

    @photo.setter
    def photo(self, photo):
        """Sets the photo of this BotPatch.

        Request to set bot photo  # noqa: E501

        :param photo: The photo of this BotPatch.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BotPatch):
            return False

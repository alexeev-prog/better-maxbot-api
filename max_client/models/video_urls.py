...
class VideoUrls(object):
    ...
    def __init__(
        ...
        """VideoUrls - a model defined in OpenAPI"""  # noqa: E501
        ...
        if mp4_1080 is not None:
            self.mp4_1080 = mp4_1080
        if mp4_720 is not None:
            self.mp4_720 = mp4_720
        if mp4_480 is not None:
            self.mp4_480 = mp4_480
        if mp4_360 is not None:
            self.mp4_360 = mp4_360
        if mp4_240 is not None:
            self.mp4_240 = mp4_240
        if mp4_144 is not None:
            self.mp4_144 = mp4_144
        if hls is not None:
            self.hls = hls

    @property
    def mp4_1080(self):
        """Gets the mp4_1080 of this VideoUrls.  # noqa: E501

        Video URL in 1080p resolution, if available  # noqa: E501

        :return: The mp4_1080 of this VideoUrls.  # noqa: E501
        :rtype: str
        """
        return self._mp4_1080

    @mp4_1080.setter
    def mp4_1080(self, mp4_1080):
        """Sets the mp4_1080 of this VideoUrls.

        Video URL in 1080p resolution, if available  # noqa: E501

        :param mp4_1080: The mp4_1080 of this VideoUrls.  # noqa: E501
        :type: str
        """

        self._mp4_1080 = mp4_1080

    @property
    def mp4_720(self):
        """Gets the mp4_720 of this VideoUrls.  # noqa: E501

        Video URL in 720 resolution, if available  # noqa: E501

        :return: The mp4_720 of this VideoUrls.  # noqa: E501
        :rtype: str
        """
        return self._mp4_720

    @mp4_720.setter
    def mp4_720(self, mp4_720):
        """Sets the mp4_720 of this VideoUrls.

        Video URL in 720 resolution, if available  # noqa: E501

        :param mp4_720: The mp4_720 of this VideoUrls.  # noqa: E501
        :type: str
        """

        self._mp4_720 = mp4_720

    @property
    def mp4_480(self):
        """Gets the mp4_480 of this VideoUrls.  # noqa: E501

        Video URL in 480 resolution, if available  # noqa: E501

        :return: The mp4_480 of this VideoUrls.  # noqa: E501
        :rtype: str
        """
        return self._mp4_480

    @mp4_480.setter
    def mp4_480(self, mp4_480):
        """Sets the mp4_480 of this VideoUrls.

        Video URL in 480 resolution, if available  # noqa: E501

        :param mp4_480: The mp4_480 of this VideoUrls.  # noqa: E501
        :type: str
        """

        self._mp4_480 = mp4_480

    @property
    def mp4_360(self):
        """Gets the mp4_360 of this VideoUrls.  # noqa: E501

        Video URL in 360 resolution, if available  # noqa: E501

        :return: The mp4_360 of this VideoUrls.  # noqa: E501
        :rtype: str
        """
        return self._mp4_360

    @mp4_360.setter
    def mp4_360(self, mp4_360):
        """Sets the mp4_360 of this VideoUrls.

        Video URL in 360 resolution, if available  # noqa: E501

        :param mp4_360: The mp4_360 of this VideoUrls.  # noqa: E501
        :type: str
        """

        self._mp4_360 = mp4_360

    @property
    def mp4_240(self):
        """Gets the mp4_240 of this VideoUrls.  # noqa: E501

        Video URL in 240 resolution, if available  # noqa: E501

        :return: The mp4_240 of this VideoUrls.  # noqa: E501
        :rtype: str
        """
        return self._mp4_240

    @mp4_240.setter
    def mp4_240(self, mp4_240):
        """Sets the mp4_240 of this VideoUrls.

        Video URL in 240 resolution, if available  # noqa: E501

        :param mp4_240: The mp4_240 of this VideoUrls.  # noqa: E501
        :type: str
        """

        self._mp4_240 = mp4_240

    @property
    def mp4_144(self):
        """Gets the mp4_144 of this VideoUrls.  # noqa: E501

        Video URL in 144 resolution, if available  # noqa: E501

        :return: The mp4_144 of this VideoUrls.  # noqa: E501
        :rtype: str
        """
        return self._mp4_144

    @mp4_144.setter
    def mp4_144(self, mp4_144):
        """Sets the mp4_144 of this VideoUrls.

        Video URL in 144 resolution, if available  # noqa: E501

        :param mp4_144: The mp4_144 of this VideoUrls.  # noqa: E501
        :type: str
        """

        self._mp4_144 = mp4_144

    @property
    def hls(self):
        """Gets the hls of this VideoUrls.  # noqa: E501

        Live streaming URL, if available  # noqa: E501

        :return: The hls of this VideoUrls.  # noqa: E501
        :rtype: str
        """
        return self._hls
    ...
    @hls.setter
    def hls(self, hls):
        """Sets the hls of this VideoUrls.

        Live streaming URL, if available  # noqa: E501

        :param hls: The hls of this VideoUrls.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VideoUrls):
            return False

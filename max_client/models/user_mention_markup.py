...
class UserMentionMarkup(MarkupElement):
    ...
    def __init__(
        self, type="user_mention", _from=None, length=None, user_link=None, user_id=None
    ):  # noqa: E501
        """UserMentionMarkup - a model defined in OpenAPI"""  # noqa: E501
        super(UserMentionMarkup, self).__init__(type, _from, length)
    ...
    @property
    def user_link(self):
        """Gets the user_link of this UserMentionMarkup.  # noqa: E501

        `@username` of mentioned user  # noqa: E501

        :return: The user_link of this UserMentionMarkup.  # noqa: E501
        :rtype: str
        """
    ...
    def user_link(self, user_link):
        """Sets the user_link of this UserMentionMarkup.

        `@username` of mentioned user  # noqa: E501

        :param user_link: The user_link of this UserMentionMarkup.  # noqa: E501
        :type: str
        """
    ...
    @property
    def user_id(self):
        """Gets the user_id of this UserMentionMarkup.  # noqa: E501

        Identifier of mentioned user without username  # noqa: E501

        :return: The user_id of this UserMentionMarkup.  # noqa: E501
        :rtype: int
        """
    ...
    def user_id(self, user_id):
        """Sets the user_id of this UserMentionMarkup.

        Identifier of mentioned user without username  # noqa: E501

        :param user_id: The user_id of this UserMentionMarkup.  # noqa: E501
        :type: int
        """
    ...
    def markup_apply(self, text, format):
        ...
        if format == TextFormat.HTML:
            return f'<a href="max://user/{self.user_id}">{text}</a>'
        else:
            return f"[{text}](max://user/{self.user_id})"
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserMentionMarkup):
            return False

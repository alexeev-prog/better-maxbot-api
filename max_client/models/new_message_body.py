...
class NewMessageBody:
    ...
    def __init__(
        self, text=None, attachments=None, link=None, notify=True, format=None
    ):
        """NewMessageBody - a model defined in OpenAPI."""
        self._text = None
    ...
    def text(self, text):
        ...
        if text is not None and len(text) > self.MAX_BODY_LENGTH:
            raise ValueError(
                f"Invalid value for `text`, length must be less than or equal to `{self.MAX_BODY_LENGTH}`"
            )
    ...
    def notify(self):
        ...
        If false, chat participants would not be notified  # noqa: E501
    ...
    def format(self):
        """
        Gets the format of this NewMessageBody.  # noqa: E501.

        If set, message text will be formated according to given markup  # noqa: E501

        :return: The format of this NewMessageBody.  # noqa: E501
        :rtype: TextFormat
        """
        return self._format
    ...
    def format(self, format):
        """
        Sets the format of this NewMessageBody.

        If set, message text will be formated according to given markup  # noqa: E501

        :param format: The format of this NewMessageBody.  # noqa: E501
        :type: TextFormat
        """
        self._format = format

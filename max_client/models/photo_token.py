...
class PhotoToken(object):
    ...
    def __init__(self, token=None):  # noqa: E501
        """PhotoToken - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def token(self):
        """Gets the token of this PhotoToken.  # noqa: E501

        Encoded information of uploaded image  # noqa: E501

        :return: The token of this PhotoToken.  # noqa: E501
        :rtype: str
        """
        return self._token
    ...
    def token(self, token):
        """Sets the token of this PhotoToken.

        Encoded information of uploaded image  # noqa: E501

        :param token: The token of this PhotoToken.  # noqa: E501
        :type: str
        """
        if token is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PhotoToken):
            return False

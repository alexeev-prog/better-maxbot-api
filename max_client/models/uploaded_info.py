...
class UploadedInfo(object):
    ...
    def __init__(self, token=None):  # noqa: E501
        """UploadedInfo - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def token(self):
        """Gets the token of this UploadedInfo.  # noqa: E501

        Token is unique uploaded media identifier  # noqa: E501

        :return: The token of this UploadedInfo.  # noqa: E501
        :rtype: str
        """
        return self._token
    ...
    def token(self, token):
        """Sets the token of this UploadedInfo.

        Token is unique uploaded media identifier  # noqa: E501

        :param token: The token of this UploadedInfo.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UploadedInfo):
            return False

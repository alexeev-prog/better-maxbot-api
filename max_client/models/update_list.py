...
class UpdateList:
    ...
    """
    openapi_types = {"updates": "list[Update]", "marker": "int"}

    attribute_map = {"updates": "updates", "marker": "marker"}

    def __init__(self, updates=None, marker=None):
        """UpdateList - a model defined in OpenAPI."""
        self._updates = None
        self._marker = None
    ...
    def updates(self):
        """
        Gets the updates of this UpdateList.  # noqa: E501.

        Page of updates  # noqa: E501

        :return: The updates of this UpdateList.  # noqa: E501
        :rtype: list[Update]
        """
    ...
    def updates(self, updates):
        """
        Sets the updates of this UpdateList.

        Page of updates  # noqa: E501

        :param updates: The updates of this UpdateList.  # noqa: E501
        :type: list[Update]
        """
        if updates is None:
    ...
    def marker(self):
        """
        Gets the marker of this UpdateList.  # noqa: E501.

        Pointer to the next data page  # noqa: E501

        :return: The marker of this UpdateList.  # noqa: E501
        :rtype: int
        """
        return self._marker
    ...
    def marker(self, marker):
        """
        Sets the marker of this UpdateList.

        Pointer to the next data page  # noqa: E501

        :param marker: The marker of this UpdateList.  # noqa: E501
        :type: int
        """
        self._marker = marker

...
class BotStartedUpdate(Update):
    ...
    def __init__(
        ...
        """BotStartedUpdate - a model defined in OpenAPI."""
    ...
    def chat_id(self):
        """
        Gets the chat_id of this BotStartedUpdate.  # noqa: E501.

        Dialog identifier where event has occurred  # noqa: E501

        :return: The chat_id of this BotStartedUpdate.  # noqa: E501
        :rtype: int
        """
    ...
    def chat_id(self, chat_id):
        """
        Sets the chat_id of this BotStartedUpdate.

        Dialog identifier where event has occurred  # noqa: E501

        :param chat_id: The chat_id of this BotStartedUpdate.  # noqa: E501
        :type: int
        """
        if chat_id is None:
    ...
    def user(self):
        """
        Gets the user of this BotStartedUpdate.  # noqa: E501.

        User pressed the 'Start' button  # noqa: E501

        :return: The user of this BotStartedUpdate.  # noqa: E501
        :rtype: User
        """
        return self._user
    ...
    def user(self, user):
        """
        Sets the user of this BotStartedUpdate.

        User pressed the 'Start' button  # noqa: E501

        :param user: The user of this BotStartedUpdate.  # noqa: E501
        :type: User
        """
        if user is None:
    ...
    def payload(self):
        """
        Gets the payload of this BotStartedUpdate.  # noqa: E501.

        Additional data from deep-link passed on bot startup  # noqa: E501

        :return: The payload of this BotStartedUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def payload(self, payload):
        """
        Sets the payload of this BotStartedUpdate.

        Additional data from deep-link passed on bot startup  # noqa: E501

        :param payload: The payload of this BotStartedUpdate.  # noqa: E501
        :type: str
        """
        if payload is not None and len(payload) > 512:
            raise ValueError(
                "Invalid value for `payload`, length must be less than or equal to `512`"
            )
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BotStartedUpdate):
            return False

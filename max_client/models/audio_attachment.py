...
class AudioAttachment(Attachment):
    ...
    def __init__(self, payload=None, type="audio"):  # noqa: E501
        """AudioAttachment - a model defined in OpenAPI"""  # noqa: E501
        super(AudioAttachment, self).__init__(type)
        self._payload = None
    ...
    @property
    def payload(self):
        """Gets the payload of this AudioAttachment.  # noqa: E501


        :return: The payload of this AudioAttachment.  # noqa: E501
    ...
    def payload(self, payload):
        """Sets the payload of this AudioAttachment.


        :param payload: The payload of this AudioAttachment.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AudioAttachment):
            return False

...
class ContactAttachmentRequestPayload:
    """NOTE:"""
    ...
    def __init__(self, name=None, contact_id=None, vcf_info=None, vcf_phone=None):
        """ContactAttachmentRequestPayload - a model defined in OpenAPI."""
        self._name = None

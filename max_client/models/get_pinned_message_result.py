...
class GetPinnedMessageResult(object):
    """NOTE:"""
    ...
    """
    openapi_types = {"message": "Message"}

    attribute_map = {"message": "message"}

    def __init__(self, message=None):  # noqa: E501
        """GetPinnedMessageResult - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def message(self):
        """Gets the message of this GetPinnedMessageResult.  # noqa: E501

        Pinned message. Can be `null` if no message pinned in chat  # noqa: E501

        :return: The message of this GetPinnedMessageResult.  # noqa: E501
        :rtype: Message
        """
    ...
    def message(self, message):
        """Sets the message of this GetPinnedMessageResult.

        Pinned message. Can be `null` if no message pinned in chat  # noqa: E501

        :param message: The message of this GetPinnedMessageResult.  # noqa: E501
        :type: Message
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetPinnedMessageResult):
            return False

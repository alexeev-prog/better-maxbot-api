...
class ChatTitleChangedUpdate(Update):
    ...
    def __init__(
        ...
        """ChatTitleChangedUpdate - a model defined in OpenAPI"""  # noqa: E501
        super(ChatTitleChangedUpdate, self).__init__(update_type, timestamp)
        self._chat_id = None
        self._user = None
        self._title = None
    ...
    @property
    def chat_id(self):
        """Gets the chat_id of this ChatTitleChangedUpdate.  # noqa: E501

        Chat identifier where event has occurred  # noqa: E501

        :return: The chat_id of this ChatTitleChangedUpdate.  # noqa: E501
        :rtype: int
        """
    ...
    def chat_id(self, chat_id):
        """Sets the chat_id of this ChatTitleChangedUpdate.

        Chat identifier where event has occurred  # noqa: E501

        :param chat_id: The chat_id of this ChatTitleChangedUpdate.  # noqa: E501
        :type: int
        """
        if chat_id is None:
    ...
    @property
    def user(self):
        """Gets the user of this ChatTitleChangedUpdate.  # noqa: E501

        User who changed title  # noqa: E501

        :return: The user of this ChatTitleChangedUpdate.  # noqa: E501
        :rtype: User
        """
        return self._user
    ...
    @user.setter
    def user(self, user):
        """Sets the user of this ChatTitleChangedUpdate.

        User who changed title  # noqa: E501

        :param user: The user of this ChatTitleChangedUpdate.  # noqa: E501
        :type: User
        """
        if user is None:
    ...
    @property
    def title(self):
        """Gets the title of this ChatTitleChangedUpdate.  # noqa: E501

        New title  # noqa: E501

        :return: The title of this ChatTitleChangedUpdate.  # noqa: E501
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """Sets the title of this ChatTitleChangedUpdate.

        New title  # noqa: E501

        :param title: The title of this ChatTitleChangedUpdate.  # noqa: E501
        :type: str
        """
        if title is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ChatTitleChangedUpdate):
            return False

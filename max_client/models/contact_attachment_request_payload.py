...
class ContactAttachmentRequestPayload(object):
    """NOTE:"""
    ...
    def __init__(self, name=None, contact_id=None, vcf_info=None, vcf_phone=None):  # noqa: E501
        """ContactAttachmentRequestPayload - a model defined in OpenAPI"""  # noqa: E501

        self._name = None
        self._contact_id = None
        self._vcf_info = None
        self._vcf_phone = None
        self.discriminator = None

        self.name = name
        self.contact_id = contact_id
        self.vcf_info = vcf_info
        self.vcf_phone = vcf_phone

    @property
    def name(self):
        """Gets the name of this ContactAttachmentRequestPayload.  # noqa: E501

        Contact name  # noqa: E501

        :return: The name of this ContactAttachmentRequestPayload.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ContactAttachmentRequestPayload.

        Contact name  # noqa: E501

        :param name: The name of this ContactAttachmentRequestPayload.  # noqa: E501
        :type: str
        """
    ...
    @property
    def contact_id(self):
        """Gets the contact_id of this ContactAttachmentRequestPayload.  # noqa: E501

        :return: The contact_id of this ContactAttachmentRequestPayload.  # noqa: E501
        :rtype: int
        """
    ...
    def contact_id(self, contact_id):
        """Sets the contact_id of this ContactAttachmentRequestPayload.

        :param contact_id: The contact_id of this ContactAttachmentRequestPayload.  # noqa: E501
        :type: int
        """
    ...
    @property
    def vcf_info(self):
        """Gets the vcf_info of this ContactAttachmentRequestPayload.  # noqa: E501

        Full information about contact in VCF format  # noqa: E501

        :return: The vcf_info of this ContactAttachmentRequestPayload.  # noqa: E501
        :rtype: str
        """
        return self._vcf_info

    @vcf_info.setter
    def vcf_info(self, vcf_info):
        """Sets the vcf_info of this ContactAttachmentRequestPayload.

        Full information about contact in VCF format  # noqa: E501

        :param vcf_info: The vcf_info of this ContactAttachmentRequestPayload.  # noqa: E501
        :type: str
        """

        self._vcf_info = vcf_info

    @property
    def vcf_phone(self):
        """Gets the vcf_phone of this ContactAttachmentRequestPayload.  # noqa: E501

        Contact phone in VCF format  # noqa: E501

        :return: The vcf_phone of this ContactAttachmentRequestPayload.  # noqa: E501
        :rtype: str
        """
        return self._vcf_phone

    @vcf_phone.setter
    def vcf_phone(self, vcf_phone):
        """Sets the vcf_phone of this ContactAttachmentRequestPayload.

        Contact phone in VCF format  # noqa: E501

        :param vcf_phone: The vcf_phone of this ContactAttachmentRequestPayload.  # noqa: E501
        :type: str
        """

        self._vcf_phone = vcf_phone
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ContactAttachmentRequestPayload):
            return False

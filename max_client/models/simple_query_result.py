...
class SimpleQueryResult(object):
    """NOTE:"""
    ...
    def __init__(self, success=None, message=None):  # noqa: E501
        """SimpleQueryResult - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def success(self):
        """Gets the success of this SimpleQueryResult.  # noqa: E501

        `true` if request was successful. `false` otherwise  # noqa: E501

        :return: The success of this SimpleQueryResult.  # noqa: E501
        :rtype: bool
        """
    ...
    def success(self, success):
        """Sets the success of this SimpleQueryResult.

        `true` if request was successful. `false` otherwise  # noqa: E501

        :param success: The success of this SimpleQueryResult.  # noqa: E501
        :type: bool
        """
        if success is None:
    ...
    @property
    def message(self):
        """Gets the message of this SimpleQueryResult.  # noqa: E501

        Explanatory message if the result is not successful  # noqa: E501

        :return: The message of this SimpleQueryResult.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this SimpleQueryResult.

        Explanatory message if the result is not successful  # noqa: E501

        :param message: The message of this SimpleQueryResult.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleQueryResult):
            return False

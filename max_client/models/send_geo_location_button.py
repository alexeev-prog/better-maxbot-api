...
class SendGeoLocationButton(object):
    """NOTE:"""
    ...
    """
    openapi_types = {"quick": "bool"}

    attribute_map = {"quick": "quick"}

    def __init__(self, quick=False):  # noqa: E501
        """SendGeoLocationButton - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def quick(self):
        """Gets the quick of this SendGeoLocationButton.  # noqa: E501

        If *true*, sends location without asking user's confirmation  # noqa: E501

        :return: The quick of this SendGeoLocationButton.  # noqa: E501
        :rtype: bool
        """
        return self._quick
    ...
    def quick(self, quick):
        """Sets the quick of this SendGeoLocationButton.

        If *true*, sends location without asking user's confirmation  # noqa: E501

        :param quick: The quick of this SendGeoLocationButton.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SendGeoLocationButton):
            return False

...
class EmphasizedMarkup(MarkupElement):
    ...
    def __init__(self, type="emphasized", _from=None, length=None):  # noqa: E501
        """EmphasizedMarkup - a model defined in OpenAPI"""  # noqa: E501
        super(EmphasizedMarkup, self).__init__(type, _from, length)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EmphasizedMarkup):
            return False

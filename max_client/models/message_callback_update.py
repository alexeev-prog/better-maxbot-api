...
class MessageCallbackUpdate(Update):
    ...
    def __init__(
        ...
        """MessageCallbackUpdate - a model defined in OpenAPI."""
    ...
    def callback(self):
        """
        Gets the callback of this MessageCallbackUpdate.  # noqa: E501.

        :return: The callback of this MessageCallbackUpdate.  # noqa: E501
        :rtype: Callback
        """
    ...
    def callback(self, callback):
        """
        Sets the callback of this MessageCallbackUpdate.

        :param callback: The callback of this MessageCallbackUpdate.  # noqa: E501
        :type: Callback
        """
        if callback is None:
    ...
    def message(self):
        """
        Gets the message of this MessageCallbackUpdate.  # noqa: E501.

        Original message containing inline keyboard. Can be `null` in case it had been deleted by the moment a bot got this update  # noqa: E501

        :return: The message of this MessageCallbackUpdate.  # noqa: E501
        :rtype: Message
        """
    ...
    def message(self, message):
        """
        Sets the message of this MessageCallbackUpdate.

        Original message containing inline keyboard. Can be `null` in case it had been deleted by the moment a bot got this update  # noqa: E501

        :param message: The message of this MessageCallbackUpdate.  # noqa: E501
        :type: Message
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MessageCallbackUpdate):
            return False

...
class BotsApi:
    ...
    def edit_my_info(self, bot_patch, **kwargs):
        """
        ...
        if kwargs.get("async_req"):
            return self.edit_my_info_with_http_info(bot_patch, **kwargs)
        return self.edit_my_info_with_http_info(bot_patch, **kwargs)

    def edit_my_info_with_http_info(self, bot_patch, **kwargs):
        """
        Edit current bot info  # noqa: E501.
        ...
        if "bot_patch" not in local_var_params or local_var_params["bot_patch"] is None:
            raise ValueError(
                "Missing the required parameter `bot_patch` when calling `edit_my_info`"
            )
    ...
    def get_my_info(self, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_my_info_with_http_info(**kwargs)
        return self.get_my_info_with_http_info(**kwargs)

    def get_my_info_with_http_info(self, **kwargs):
        """
        Get current bot info  # noqa: E501.

...
class PhotoTokens(object):
    ...
    """
    openapi_types = {"photos": "dict(str, PhotoToken)"}

    attribute_map = {"photos": "photos"}

    def __init__(self, photos=None):  # noqa: E501
        """PhotoTokens - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def photos(self):
        """Gets the photos of this PhotoTokens.  # noqa: E501


        :return: The photos of this PhotoTokens.  # noqa: E501
    ...
    def photos(self, photos):
        """Sets the photos of this PhotoTokens.


        :param photos: The photos of this PhotoTokens.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PhotoTokens):
            return False

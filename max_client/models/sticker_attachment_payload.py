...
class StickerAttachmentPayload(object):
    """NOTE:"""
    ...
    def __init__(self, code=None):  # noqa: E501
        """StickerAttachmentPayload - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def code(self):
        """Gets the code of this StickerAttachmentPayload.  # noqa: E501

        Sticker identifier  # noqa: E501

        :return: The code of this StickerAttachmentPayload.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this StickerAttachmentPayload.

        Sticker identifier  # noqa: E501

        :param code: The code of this StickerAttachmentPayload.  # noqa: E501
        :type: str
        """
        if code is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StickerAttachmentPayload):
            return False

...
class UserIdsList(object):
    ...
    """
    openapi_types = {"user_ids": "list[int]"}

    attribute_map = {"user_ids": "user_ids"}

    def __init__(self, user_ids=None):  # noqa: E501
        """UserIdsList - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def user_ids(self):
        """Gets the user_ids of this UserIdsList.  # noqa: E501


        :return: The user_ids of this UserIdsList.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def user_ids(self, user_ids):
        """Sets the user_ids of this UserIdsList.


        :param user_ids: The user_ids of this UserIdsList.  # noqa: E501
        :type: list[int]
        """
        if user_ids is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserIdsList):
            return False

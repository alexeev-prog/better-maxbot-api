...
class StickerAttachmentRequestPayload(object):
    """NOTE:"""
    ...
    def __init__(self, code=None):  # noqa: E501
        """StickerAttachmentRequestPayload - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def code(self):
        """Gets the code of this StickerAttachmentRequestPayload.  # noqa: E501

        Sticker code  # noqa: E501

        :return: The code of this StickerAttachmentRequestPayload.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this StickerAttachmentRequestPayload.

        Sticker code  # noqa: E501

        :param code: The code of this StickerAttachmentRequestPayload.  # noqa: E501
        :type: str
        """
        if code is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StickerAttachmentRequestPayload):
            return False

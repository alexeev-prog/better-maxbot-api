...
class ChatAdminsList(object):
    ...
    """
    openapi_types = {"admins": "list[ChatAdmin]"}

    attribute_map = {"admins": "admins"}

    def __init__(self, admins=None):  # noqa: E501
        """ChatAdminsList - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def admins(self):
        """Gets the admins of this ChatAdminsList.  # noqa: E501


        :return: The admins of this ChatAdminsList.  # noqa: E501
        :rtype: list[ChatAdmin]
        """
        return self._admins

    @admins.setter
    def admins(self, admins):
        """Sets the admins of this ChatAdminsList.


        :param admins: The admins of this ChatAdminsList.  # noqa: E501
        :type: list[ChatAdmin]
        """
        if admins is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ChatAdminsList):
            return False

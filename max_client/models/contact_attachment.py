...
class ContactAttachment(Attachment):
    ...
    """
    openapi_types = {"type": "str", "payload": "ContactAttachmentPayload"}

    attribute_map = {"type": "type", "payload": "payload"}

    def __init__(self, payload=None, type="contact"):  # noqa: E501
        """ContactAttachment - a model defined in OpenAPI"""  # noqa: E501
        super(ContactAttachment, self).__init__(type)
        self._payload = None
    ...
    @property
    def payload(self):
        """Gets the payload of this ContactAttachment.  # noqa: E501


        :return: The payload of this ContactAttachment.  # noqa: E501
        :rtype: ContactAttachmentPayload
        """
        return self._payload

    @payload.setter
    def payload(self, payload):
        """Sets the payload of this ContactAttachment.


        :param payload: The payload of this ContactAttachment.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ContactAttachment):
            return False

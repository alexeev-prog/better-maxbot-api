...
class ChatButton(Button):
    ...
    CHAT_DESCRIPTION_MAX_LENGTH = 400
    START_PAYLOAD_MAX_LENGTH = 512
    ...
    def __init__(
        ...
        """ChatButton - a model defined in OpenAPI"""  # noqa: E501
        super(ChatButton, self).__init__(type, text)
        self._chat_title = None
        self._chat_description = None
    ...
    @property
    def chat_title(self):
        """Gets the chat_title of this ChatButton.  # noqa: E501

        Title of chat to be created  # noqa: E501

        :return: The chat_title of this ChatButton.  # noqa: E501
        :rtype: str
        """
        return self._chat_title

    @chat_title.setter
    def chat_title(self, chat_title):
        """Sets the chat_title of this ChatButton.

        Title of chat to be created  # noqa: E501

        :param chat_title: The chat_title of this ChatButton.  # noqa: E501
        :type: str
        """
        if chat_title is None:
            raise ValueError("Invalid value for `chat_title`, must not be `None`")  # noqa: E501
        if chat_title is not None and len(chat_title) > self.CHAT_TITLE_MAX_LENGTH:
            raise ValueError(
                "Invalid value for `chat_title`, length must be less than or equal to `%s`"
                % self.CHAT_TITLE_MAX_LENGTH
            )  # noqa: E501

        self._chat_title = chat_title

    @property
    def chat_description(self):
        """Gets the chat_description of this ChatButton.  # noqa: E501

        Chat description  # noqa: E501

        :return: The chat_description of this ChatButton.  # noqa: E501
        :rtype: str
        """
        return self._chat_description

    @chat_description.setter
    def chat_description(self, chat_description):
        """Sets the chat_description of this ChatButton.

        Chat description  # noqa: E501

        :param chat_description: The chat_description of this ChatButton.  # noqa: E501
        :type: str
        """
        if (
            chat_description is not None
            and len(chat_description) > self.CHAT_DESCRIPTION_MAX_LENGTH
        ):
            raise ValueError(
                "Invalid value for `chat_description`, length must be less than or equal to `%s`"
                % self.CHAT_DESCRIPTION_MAX_LENGTH
            )  # noqa: E501
    ...
    def start_payload(self):
        """Gets the start_payload of this ChatButton.  # noqa: E501

        Start payload will be sent to bot as soon as chat created  # noqa: E501

        :return: The start_payload of this ChatButton.  # noqa: E501
        :rtype: str
        """
        return self._start_payload

    @start_payload.setter
    def start_payload(self, start_payload):
        """Sets the start_payload of this ChatButton.

        Start payload will be sent to bot as soon as chat created  # noqa: E501

        :param start_payload: The start_payload of this ChatButton.  # noqa: E501
        :type: str
        """
        if (
            start_payload is not None
            and len(start_payload) > self.START_PAYLOAD_MAX_LENGTH
        ):
            raise ValueError(
                "Invalid value for `start_payload`, length must be less than or equal to `%s`"
                % self.START_PAYLOAD_MAX_LENGTH
            )  # noqa: E501
    ...
    @property
    def uuid(self):
        """Gets the uuid of this ChatButton.  # noqa: E501

        Unique button identifier across all chat buttons in keyboard. If `uuid` changed, new chat will be created on the next click. Server will generate it at the time when button initially posted. Reuse it when you edit the message.'  # noqa: E501

        :return: The uuid of this ChatButton.  # noqa: E501
        :rtype: int
        """
        return self._uuid
    ...
    @uuid.setter
    def uuid(self, uuid):
        """Sets the uuid of this ChatButton.

        Unique button identifier across all chat buttons in keyboard. If `uuid` changed, new chat will be created on the next click. Server will generate it at the time when button initially posted. Reuse it when you edit the message.'  # noqa: E501

        :param uuid: The uuid of this ChatButton.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ChatButton):
            return False

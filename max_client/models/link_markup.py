...
class LinkMarkup(MarkupElement):
    ...
    """
    openapi_types = {"type": "str", "_from": "int", "length": "int", "url": "str"}

    attribute_map = {"type": "type", "_from": "from", "length": "length", "url": "url"}

    def __init__(self, type="link", _from=None, length=None, url=None):  # noqa: E501
        """LinkMarkup - a model defined in OpenAPI"""  # noqa: E501
        super(LinkMarkup, self).__init__(type, _from, length)
        self._url = None
    ...
    @property
    def url(self):
        """Gets the url of this LinkMarkup.  # noqa: E501

        Link's URL  # noqa: E501

        :return: The url of this LinkMarkup.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this LinkMarkup.

        Link's URL  # noqa: E501

        :param url: The url of this LinkMarkup.  # noqa: E501
        :type: str
        """
        if url is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LinkMarkup):
            return False

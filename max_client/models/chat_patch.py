...
class ChatPatch(object):
    ...
    attribute_map = {"icon": "icon", "title": "title", "pin": "pin", "notify": "notify"}

    def __init__(self, icon=None, title=None, pin=None, notify=True):  # noqa: E501
        """ChatPatch - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def icon(self):
        """Gets the icon of this ChatPatch.  # noqa: E501


        :return: The icon of this ChatPatch.  # noqa: E501
    ...
    @icon.setter
    def icon(self, icon):
        """Sets the icon of this ChatPatch.


        :param icon: The icon of this ChatPatch.  # noqa: E501
    ...
    @property
    def title(self):
        """Gets the title of this ChatPatch.  # noqa: E501


        :return: The title of this ChatPatch.  # noqa: E501
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """Sets the title of this ChatPatch.


        :param title: The title of this ChatPatch.  # noqa: E501
        :type: str
        """
        if title is not None and len(title) > 200:
            raise ValueError(
                "Invalid value for `title`, length must be less than or equal to `200`"
            )  # noqa: E501
        if title is not None and len(title) < 1:
            raise ValueError(
                "Invalid value for `title`, length must be greater than or equal to `1`"
            )  # noqa: E501
    ...
    @property
    def pin(self):
        """Gets the pin of this ChatPatch.  # noqa: E501

        Identifier of message to be pinned in chat. In case you want to remove pin, use [unpin](#operation/unpinMessage) method  # noqa: E501

        :return: The pin of this ChatPatch.  # noqa: E501
        :rtype: str
        """
        return self._pin
    ...
    @pin.setter
    def pin(self, pin):
        """Sets the pin of this ChatPatch.

        Identifier of message to be pinned in chat. In case you want to remove pin, use [unpin](#operation/unpinMessage) method  # noqa: E501

        :param pin: The pin of this ChatPatch.  # noqa: E501
        :type: str
        """
    ...
    @property
    def notify(self):
        """Gets the notify of this ChatPatch.  # noqa: E501

        By default, participants will be notified about change with system message in chat/channel  # noqa: E501

        :return: The notify of this ChatPatch.  # noqa: E501
        :rtype: bool
        """
        return self._notify
    ...
    def notify(self, notify):
        """Sets the notify of this ChatPatch.

        By default, participants will be notified about change with system message in chat/channel  # noqa: E501

        :param notify: The notify of this ChatPatch.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ChatPatch):
            return False

...
class GetSubscriptionsResult(object):
    ...
    """
    openapi_types = {"subscriptions": "list[Subscription]"}

    attribute_map = {"subscriptions": "subscriptions"}

    def __init__(self, subscriptions=None):  # noqa: E501
        """GetSubscriptionsResult - a model defined in OpenAPI"""  # noqa: E501
    ...
    def subscriptions(self):
        """Gets the subscriptions of this GetSubscriptionsResult.  # noqa: E501

        Current subscriptions  # noqa: E501

        :return: The subscriptions of this GetSubscriptionsResult.  # noqa: E501
    ...
    def subscriptions(self, subscriptions):
        """Sets the subscriptions of this GetSubscriptionsResult.

        Current subscriptions  # noqa: E501

        :param subscriptions: The subscriptions of this GetSubscriptionsResult.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetSubscriptionsResult):
            return False

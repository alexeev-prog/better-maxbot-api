...
class MessageStat(object):
    ...
    def __init__(self, views=None):  # noqa: E501
        """MessageStat - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def views(self):
        """Gets the views of this MessageStat.  # noqa: E501


        :return: The views of this MessageStat.  # noqa: E501
        :rtype: int
        """
        return self._views
    ...
    def views(self, views):
        """Sets the views of this MessageStat.


        :param views: The views of this MessageStat.  # noqa: E501
        :type: int
        """
        if views is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MessageStat):
            return False

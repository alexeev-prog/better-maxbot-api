...
class ReplyButton(object):
    ...
    """
    openapi_types = {"text": "str", "payload": "str"}

    attribute_map = {"text": "text", "payload": "payload"}

    discriminator_value_class_map = {
        "SendMessageButton": "SendMessageButton",
        "SendGeoLocationButton": "SendGeoLocationButton",
        "SendContactButton": "SendContactButton",
    }

    def __init__(self, text=None, payload=None):  # noqa: E501
        """ReplyButton - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def text(self):
        """Gets the text of this ReplyButton.  # noqa: E501

        Visible text of button  # noqa: E501

        :return: The text of this ReplyButton.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this ReplyButton.

        Visible text of button  # noqa: E501

        :param text: The text of this ReplyButton.  # noqa: E501
        :type: str
        """
        if text is None:
        ...
        if text is not None and len(text) > 128:
            raise ValueError(
                "Invalid value for `text`, length must be less than or equal to `128`"
            )  # noqa: E501
        if text is not None and len(text) < 1:
            raise ValueError(
                "Invalid value for `text`, length must be greater than or equal to `1`"
            )  # noqa: E501
    ...
    @property
    def payload(self):
        """Gets the payload of this ReplyButton.  # noqa: E501

        Button payload  # noqa: E501

        :return: The payload of this ReplyButton.  # noqa: E501
        :rtype: str
        """
    ...
    def payload(self, payload):
        """Sets the payload of this ReplyButton.

        Button payload  # noqa: E501

        :param payload: The payload of this ReplyButton.  # noqa: E501
        :type: str
        """
        if payload is not None and len(payload) > 1024:
            raise ValueError(
                "Invalid value for `payload`, length must be less than or equal to `1024`"
            )  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReplyButton):
            return False

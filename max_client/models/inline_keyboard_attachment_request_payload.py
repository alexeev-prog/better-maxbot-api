...
class InlineKeyboardAttachmentRequestPayload(object):
    """NOTE:"""
    ...
    """
    openapi_types = {"buttons": "list[list[Button]]"}

    attribute_map = {"buttons": "buttons"}

    def __init__(self, buttons=None):  # noqa: E501
        """InlineKeyboardAttachmentRequestPayload - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def buttons(self):
        """Gets the buttons of this InlineKeyboardAttachmentRequestPayload.  # noqa: E501

        Two-dimensional array of buttons  # noqa: E501

        :return: The buttons of this InlineKeyboardAttachmentRequestPayload.  # noqa: E501
    ...
    def buttons(self, buttons):
        """Sets the buttons of this InlineKeyboardAttachmentRequestPayload.

        Two-dimensional array of buttons  # noqa: E501

        :param buttons: The buttons of this InlineKeyboardAttachmentRequestPayload.  # noqa: E501
        :type: list[list[Button]]
        """
        if buttons is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineKeyboardAttachmentRequestPayload):
            return False

...
class TestMessagesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = max_client.api.messages_api.MessagesApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_answer_on_callback(self):
        """Test case for answer_on_callback
    ...
    def test_get_video_attachment_details(self):
        """Test case for get_video_attachment_details

        Get video details  # noqa: E501
        """
        pass

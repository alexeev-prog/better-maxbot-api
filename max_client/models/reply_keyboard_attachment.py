...
class ReplyKeyboardAttachment(object):
    """NOTE:"""
    ...
    """
    openapi_types = {"buttons": "list[list[ReplyButton]]"}

    attribute_map = {"buttons": "buttons"}

    def __init__(self, buttons=None):  # noqa: E501
        """ReplyKeyboardAttachment - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def buttons(self):
        """Gets the buttons of this ReplyKeyboardAttachment.  # noqa: E501


        :return: The buttons of this ReplyKeyboardAttachment.  # noqa: E501
    ...
    def buttons(self, buttons):
        """Sets the buttons of this ReplyKeyboardAttachment.


        :param buttons: The buttons of this ReplyKeyboardAttachment.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReplyKeyboardAttachment):
            return False

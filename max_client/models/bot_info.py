...
class BotInfo(UserWithPhoto):
    ...
    def __init__(
        ...
        """BotInfo - a model defined in OpenAPI."""
        super().__init__(
            description,
            user_id,
            name,
    ...
    def commands(self):
        """
        Gets the commands of this BotInfo.  # noqa: E501.

        Commands supported by bot  # noqa: E501

        :return: The commands of this BotInfo.  # noqa: E501
    ...
    def commands(self, commands):
        """
        Sets the commands of this BotInfo.

        Commands supported by bot  # noqa: E501

        :param commands: The commands of this BotInfo.  # noqa: E501

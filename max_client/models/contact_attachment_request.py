...
class ContactAttachmentRequest(AttachmentRequest):
    ...
    """
    openapi_types = {"type": "str", "payload": "ContactAttachmentRequestPayload"}

    attribute_map = {"type": "type", "payload": "payload"}

    def __init__(self, payload=None, type="contact"):  # noqa: E501
        """ContactAttachmentRequest - a model defined in OpenAPI"""  # noqa: E501
        super(ContactAttachmentRequest, self).__init__(type)
        self._payload = None
    ...
    @property
    def payload(self):
        """Gets the payload of this ContactAttachmentRequest.  # noqa: E501


        :return: The payload of this ContactAttachmentRequest.  # noqa: E501
        :rtype: ContactAttachmentRequestPayload
        """
        return self._payload

    @payload.setter
    def payload(self, payload):
        """Sets the payload of this ContactAttachmentRequest.


        :param payload: The payload of this ContactAttachmentRequest.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ContactAttachmentRequest):
            return False
